...
public partial class Contexts : Entitas.IContexts {
    ...
    public NodeSystemContext nodeSystem { get; set; }
    public ProgressContext progress { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { game, nodeSystem, progress }; } }

    public Contexts() {
        game = new GameContext();
        nodeSystem = new NodeSystemContext();
        progress = new ProgressContext();
...
public partial class Contexts {
    ...
    public void InitializeContextObservers() {
        try {
            ...
            CreateContextObserver(nodeSystem);
            CreateContextObserver(progress);
