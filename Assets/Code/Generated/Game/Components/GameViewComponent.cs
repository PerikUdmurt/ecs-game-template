...
public partial class GameEntity {
    ...
    public Code.Infrastructures.View.IEntityView View { get { return view.Value; } }
    public bool hasView { get { return HasComponent(GameComponentsLookup.View); } }

    public GameEntity AddView(Code.Infrastructures.View.IEntityView newValue) {
    ...
    public GameEntity ReplaceView(Code.Infrastructures.View.IEntityView newValue) {
        var index = GameComponentsLookup.View;
        var component = (Code.Common.View)CreateComponent(index, typeof(Code.Common.View));
        component.Value = newValue;
