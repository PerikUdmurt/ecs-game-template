...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Effects.EffectSetupsComponent effectSetups { get { return (Code.Gameplay.Features.Effects.EffectSetupsComponent)GetComponent(GameComponentsLookup.EffectSetups); } }
    ...
    public GameEntity AddEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effects.EffectSetup> newValue) {
        ...
        var component = (Code.Gameplay.Features.Effects.EffectSetupsComponent)CreateComponent(index, typeof(Code.Gameplay.Features.Effects.EffectSetupsComponent));
